...
(function () {
			...
			: this.parent &&
			  ...
			  (null === r
					...
					: 0 < this.parent.themeOptions[p].length &&
					  ((r = Math.min(
							this.parent.themeOptions[p].length - 1,
							r
					  )),
	...
	var $a = {},
		...
		ea = function (k, p, r, u, v, H, F, z, E, L, R, N, O) {
			...
			z = z || "black";
			var I =
				15 < u - p && 15 < v - r ? 8 : 0.35 * Math.min(u - p, v - r);
			k.beginPath();
			k.moveTo(p, r);
			k.save();
			k.fillStyle = H;
	...
	V.prototype.get = function (k) {
		...
		if ("options" === k)
			return this.options && this.options._isPlaceholder
				? null
				: this.options;
		if (
			p.hasOwnProperty(k) ||
			...
			: this.parent &&
			  ...
			  (null === H
					...
					: 0 < this.parent.themeOptions[E].length &&
					  ((r = Math.min(
							this.parent.themeOptions[E].length - 1,
							H
					  )),
	...
	Ga.prototype.getFreeSpace = function () {
		return {
			...
			width:
				this._x2 - this._x1 - this._rightOccupied - this._leftOccupied,
			height:
	...
	Aa.prototype.setLayout = function () {
		if (this.text) {
			...
			"top" === this.verticalAlign || "bottom" === this.verticalAlign
				? (null === this.maxWidth &&
						(this.maxWidth =
							p.width -
							4 -
							F * ("center" === this.horizontalAlign ? 2 : 1)),
				...
				: "center" === this.verticalAlign &&
				  ...
				  "right" === this.horizontalAlign
						? (null === this.maxWidth &&
								(this.maxWidth = p.height - 4),
						  (H = 0.5 * p.width - this.margin - 2))
						: "center" === this.horizontalAlign &&
						  (null === this.maxWidth &&
								(this.maxWidth = p.width - 4),
						  (H = 0.5 * p.height - 4)));
			var L;
			...
			this.wrap ||
				(H = Math.min(
					H,
					Math.max(1.5 * this.fontSize, this.fontSize + L)
				));
			H = new ka(this.ctx, {
			...
			k.layoutManager.registerSpace(I, {
				width:
					this.width +
					("left" === I || "right" === I ? this.margin + 2 : 0),
				height:
					this.height +
					("top" === I || "bottom" === I ? this.margin + 2 : 0),
			});
			this.bounds = {
				x1: r,
				y1: v,
	...
	Na.Chart = (function () {
		...
		function p(a, d) {
			...
			if (
				...
				this.canvas.getContext &&
					...
					(this.ctx.textBaseline = "top"),
					Ea(this.ctx),
					(this._preRenderCtx = this._preRenderCanvas.getContext(
						"2d"
					)),
					...
					r
						...
						: ((this.plotArea.canvas = ta(c, e)),
						  ...
						  this._canvasJSContainer.appendChild(
								this.plotArea.canvas
						  ),
					...
					this.overlaidCanvas.getContext &&
						...
						(this.overlaidCanvasCtx = this.overlaidCanvas.getContext(
							"2d"
						)),
			...
			"axisX" === e
				? ("left" === g || "bottom" === g
						? ((this.optionsName = "axisX"),
						  ...
						  (this.sessionVariables = this.chart.sessionVariables.axisX[
								c
						  ]))
						: ((this.optionsName = "axisX2"),
						  u(this.chart.sessionVariables.axisX2[c]) &&
								(this.chart.sessionVariables.axisX2[c] = {}),
						  (this.sessionVariables = this.chart.sessionVariables.axisX2[
								c
						  ])),
		...
		function L(a, d, b, c, e, g) {
			...
			this.fillOpacity = u(b.fillOpacity)
				? g.fillOpacity
				: this.fillOpacity;
			...
			this.lineDashType = b.lineDashType
				? this.lineDashType
				: g.lineDashType;
			!u(this.startValue) &&
		...
		p.prototype._updateOptions = function () {
			...
			if (this.options.zoomEnabled) {
						...
						function () {
							...
							a.zoomEnabled || a.panEnabled
								? ((a.zoomEnabled = !0),
								  ...
								  (a.overlaidCanvas.style.cursor =
										a._defaultCursor))
								: ((a.zoomEnabled = !1), (a.panEnabled = !1));
							if (a.sessionVariables.axisX)
								for (
									var c = 0;
									c < a.sessionVariables.axisX.length;
									c++
								)
									(a.sessionVariables.axisX[
										c
									].newViewportMinimum = null),
										(a.sessionVariables.axisX[
											c
										].newViewportMaximum = null);
							if (a.sessionVariables.axisX2)
								for (
									c = 0;
									c < a.sessionVariables.axisX2.length;
									c++
								)
									(a.sessionVariables.axisX2[
										c
									].newViewportMinimum = null),
										(a.sessionVariables.axisX2[
											c
							...
							if (a.sessionVariables.axisY)
								for (
									c = 0;
									c < a.sessionVariables.axisY.length;
									c++
								)
									(a.sessionVariables.axisY[
										c
									].newViewportMinimum = null),
										(a.sessionVariables.axisY[
											c
							...
							if (a.sessionVariables.axisY2)
								for (
									c = 0;
									c < a.sessionVariables.axisY2.length;
									c++
								)
									(a.sessionVariables.axisY2[
										c
									].newViewportMinimum = null),
										(a.sessionVariables.axisY2[
											c
						...
						function () {
							d ||
								(sa(a, a._resetButton, {
									...
									color:
										a.toolbar
											.hoverFfontColorOnHoverontColor,
									transition: "0.4s",
									WebkitTransition: "0.4s",
								}),
								0 >= navigator.userAgent.search("MSIE") &&
				...
				this.zoomEnabled ||
					this.panEnabled ||
					(this._zoomButton
						? (a._zoomButton.getAttribute("state") ===
						  a._cultureInfo.zoomText
								? ((this.panEnabled = !0),
								  (this.zoomEnabled = !1))
								: ((this.zoomEnabled = !0),
								  (this.panEnabled = !1)),
			...
			"none" !== this._toolBar.style.display &&
				...
				(this.panEnabled
					? ua(a, a._zoomButton, "zoom")
					: ua(a, a._zoomButton, "pan"),
				a._resetButton.getAttribute("state") !==
					a._cultureInfo.resetText && ua(a, a._resetButton, "reset"));
			this.options.toolTip &&
				this.toolTip.options !== this.options.toolTip &&
				(this.toolTip.options = this.options.toolTip);
			for (var c in this.toolTip.options)
				this.toolTip.options.hasOwnProperty(c) &&
			...
			if (this.options.data) {
				for (var b = 0; b < this.options.data.length; b++)
					if (
						...
						!this.options.data[b].type ||
							0 <=
								p._supportedChartTypes.indexOf(
									this.options.data[b].type
								))
					) {
						var c = new F(
				...
				for (b = 0; b < this.data.length; b++) {
					...
					"error" === this.data[b].type &&
						((this.data[
							b
						].axisPlacement = this.plotInfo.axisPlacement =
							d || "normal"),
						(this.data[b]._linkedSeries =
							null === this.data[b].linkedDataSeriesIndex
								? null
								: this.data[
										this.data[b].linkedDataSeriesIndex
								  ]));
				}
			}
		...
		p.prototype.setLayout = function () {
			for (
				var a = this._plotAreaElements, d = 0;
				d < this.data.length;
				d++
			)
				if (
					...
					if (
						!this.data[d].axisYType ||
						"primary" === this.data[d].axisYType
					)
						if (
							this.options.axisY &&
							0 < this.options.axisY.length
						) {
							if (!this.axisY.length)
								for (
									var b = 0;
									b < this.options.axisY.length;
									b++
								)
									"normal" === this.plotInfo.axisPlacement
										? this._axes.push(
					...
					if (
						!this.data[d].axisXType ||
						"primary" === this.data[d].axisXType
					)
						if (
							this.options.axisX &&
							0 < this.options.axisX.length
						) {
			...
			if (this.axisY) {
				for (b = 1; b < this.axisY.length; b++)
					"undefined" ===
						typeof this.axisY[b].options.gridThickness &&
			...
			this.axisY &&
				...
				"undefined" === typeof this.axisY2[0].options.gridThickness
					...
					: 0 < this.axisY2[0].gridThickness &&
					  "undefined" ===
							typeof this.axisY[0].options.gridThickness &&
					  (this.axisY[0].gridThickness = 0));
			if (this.axisX)
				for (b = 0; b < this.axisX.length; b++)
					"undefined" ===
						typeof this.axisX[b].options.gridThickness &&
						(this.axisX[b].gridThickness = 0);
			if (this.axisX2)
				for (b = 0; b < this.axisX2.length; b++)
					"undefined" ===
						typeof this.axisX2[b].options.gridThickness &&
			...
			this.axisX &&
				...
				"undefined" === typeof this.axisX2[0].options.gridThickness
					...
					: 0 < this.axisX2[0].gridThickness &&
					  "undefined" ===
							typeof this.axisX[0].options.gridThickness &&
			...
			for (d = 0; d < this._axes.length; d++)
				if (
					...
					r
						? ((this._breaksCanvas = ta(
								this.width,
								this.height,
								!0
						  )),
						  (this._breaksCanvasCtx = this._breaksCanvas.getContext(
								"2d"
						  )))
		...
		p.prototype.renderElements = function () {
			...
			for (var d = 0; d < this.subtitles.length; d++)
				this.subtitles[d].dockInsidePlotArea ||
			...
			for (d = 0; d < this.plotInfo.plotTypes.length; d++)
				for (
					...
					"line" === l.type
						...
						: "boxAndWhisker" === l.type &&
						  (w = this.renderBoxAndWhisker(l));
					for (var h = 0; h < l.dataSeriesIndexes.length; h++)
						this._dataInRenderedOrder.push(
							this.data[l.dataSeriesIndexes[h]]
						);
					this.animatedRender &&
					...
					s._animator.animate(
						...
						function (a) {
							...
							for (var e = 0; e < b.length; e++)
								(w = b[e]),
									1 > a &&
									"undefined" !== typeof w.startTimePercent
						...
						((e = {
							...
							axisY:
								"primary" === a.axisYType
									...
									: this.axisY2[
											0 <= a.axisYIndex &&
											a.axisYIndex < this.axisY2.length
												? a.axisYIndex
												: 0
									  ],
							axisX:
								"primary" === a.axisXType
									? this.axisX[
											0 <= a.axisXIndex &&
											a.axisXIndex < this.axisX.length
												? a.axisXIndex
												: 0
									  ]
									: this.axisX2[
											0 <= a.axisXIndex &&
											a.axisXIndex < this.axisX2.length
												? a.axisXIndex
												: 0
									  ],
							dataSeriesIndexes: [],
			...
			for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
				for (
					...
					"scatter" === c.type
						...
						: "waterfall" === c.type &&
						  this._processSpecificPlotUnit(c);
				}
		...
		p.prototype._processMultiseriesPlotUnit = function (a) {
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
				for (
					...
					l.axisX.valueType = l.xValueType = g
						? "dateTime"
						: "number";
				}
		};
		p.prototype._processStackedPlotUnit = function (a) {
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				for (
					...
					q.axisX.valueType = q.xValueType = g
						? "dateTime"
						: "number";
				}
				for (n in m)
			...
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				for (
					...
					var s = this.data[a.dataSeriesIndexes[h]],
						...
						B;
					if (
						"normal" === s.axisPlacement ||
						"xySwapped" === s.axisPlacement
					)
					...
					s.axisX.valueType = s.xValueType = g
						? "dateTime"
						: "number";
				}
				a.axisY.logarithmic
					? ((d.max = u(d.viewPortMax)
					  ...
					  (d.min = u(d.viewPortMin)
							? 1
							: Math.min(d.viewPortMin, 1)))
					: m && !l
					? ((d.max = u(d.viewPortMax)
							? 99
							: Math.max(d.viewPortMax, 99)),
					  (d.min = u(d.viewPortMin)
							? 1
							: Math.min(d.viewPortMin, 1)))
					: m && l
		...
		p.prototype._processMultiYPlotUnit = function (a) {
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
				for (
					...
					h.axisX.valueType = h.xValueType = l
						? "dateTime"
						: "number";
				}
		};
		p.prototype._processSpecificPlotUnit = function (a) {
			if (
				...
				for (
					...
					for (w = 0; w < l.dataPoints.length; w++)
						"undefined" !==
							typeof l.dataPoints[w].isCumulativeSum &&
							...
							? ((l.dataPointEOs[w].cumulativeSumYStartValue = 0),
							  ...
							  (l.dataPoints[w].y =
									0 === w
										...
										: l.dataPointEOs[w - 1].cumulativeSum))
							: "undefined" !==
									typeof l.dataPoints[w].isIntermediateSum &&
				...
				for (m = 0; m < this._axes.length; m++)
					if (this._axes[m].dataInfo._dataRanges) {
						...
						if (this._axes[m].dataInfo.dataPointYPositiveSums) {
							var n = this._axes[m].dataInfo
								.dataPointYPositiveSums;
							s = h;
							for (l in n)
								if (
									n.hasOwnProperty(l) &&
						...
						if (this._axes[m].scaleBreaks.customBreaks)
							for (
								l = 0;
								l <
								this._axes[m].scaleBreaks.customBreaks.length;
								l++
							)
								for (c = 0; c < g.length; c++)
									if (
										(this._axes[m].scaleBreaks.customBreaks[
											l
										].startValue <= g[c].start &&
											g[c].start <=
												this._axes[m].scaleBreaks
													.customBreaks[l]
													.endValue) ||
						...
						this._axes[m].scaleBreaks._appliedBreaks.sort(function (
							a,
							c
						) {
							return a.startValue - c.startValue;
		...
		p.prototype.getDataPointAtXY = function (a, d, b) {
			b = b || !1;
			for (
				var c = [], e = this._dataInRenderedOrder.length - 1;
				0 <= e;
				e--
			) {
				var g = null;
			...
			for (b = 0; b < c.length; b++)
				if (
					...
					if (
						((e =
							na("markerSize", c[b].dataPoint, c[b].dataSeries) ||
							8),
						c[b].distance <= e / 2)
					) {
						d = !0;
		...
		p.prototype.validateRegion = function (a, d, b, c, e) {
			...
			for (m = 0; m < h.length; m++) {
				...
				if (q.scaleBreaks)
					for (
						B = 0;
						!g && B < q.scaleBreaks._appliedBreaks.length;
						B++
					)
						g =
					...
					if (
						...
						!(
							...
							(!(
								...
								((q.logarithmic &&
									B < Math.pow(q.dataInfo.minDiff, 3)) ||
									(!q.logarithmic &&
										B <
											3 *
												Math.abs(
		...
		p.prototype.preparePlotArea = function () {
			...
			if (
				...
				if (this.axisY && 0 < this.axisY.length && this.axisY[0]) {
					...
					a.y1 =
						d.y1 < b.lineCoordinates.y1
							? d.y1
							: b.lineCoordinates.y1;
					a.x2 =
						d.x2 > b.lineCoordinates.x2
							? d.x2
							: b.lineCoordinates.x2;
				...
				if (null !== x && "" !== x) {
					...
					if ("stackedarea100" === s) {
						...
						if (
							...
							Math.max.apply(null, h.dataPoint.y) <
								A.viewportMinimum ||
							Math.min.apply(null, h.dataPoint.y) >
								A.viewportMaximum
						)
							continue;
					} else if (
		...
		p.prototype.renderSpline = function (a) {
			function d(a) {
				...
				if (0 < a.length) {
					...
					a[0].newStrokeStyle &&
						(c.strokeStyle = a[0].newStrokeStyle);
					...
					if (0 < B.length)
						for (
							...
							if (
								...
								m = a.axisX.reversed
									? (m +
											(a.plotType.totalDataSeries * q) /
												2 -
											(a.previousDataSeriesCount + s) *
												q) <<
									  0
									: (m -
											(a.plotType.totalDataSeries * q) /
						...
						for (h = 0; h < t.length; h++)
							if (
								...
								if (
									...
									(a.axisY.scaleBreaks &&
										0 <
											a.axisY.scaleBreaks._appliedBreaks
												.length &&
										0 < t[h].y)
								)
									(l[c] = t[h].y + (l[c] ? l[c] : 0)),
									...
									(w[c] = t[h].y + (w[c] ? w[c] : 0)),
										...
										(q =
											"undefined" !== typeof m[c]
												? m[c]
												: n),
										(m[c] = y);
								else if (
									((q = a.axisY.convertValueToPixel(t[h].y)),
									0 <= t[h].y)
								) {
									var A =
						...
						for (
							...
							if (
								...
								if (
									...
									((q = a.axisY.convertValueToPixel(q)),
									0 <= t[h].y)
								) {
									var A =
										"undefined" !== typeof g[c] ? g[c] : 0;
						...
						for (h = 0; h < t.length; h++)
							if (
								...
								if (
									...
									(w[c] = t[h].y + (w[c] ? w[c] : 0)),
										(s = m[c] ? m[c] : n),
										(m[c] = y = a.axisY.convertValueToPixel(
											w[c]
										));
								else if (
									((s = a.axisY.convertValueToPixel(t[h].y)),
									0 <= t[h].y)
								) {
									var A = g[c] ? g[c] : 0;
									y = n + A;
						...
						for (h = 0; h < t.length; h++)
							if (
								...
								if (
									...
									if (0 >= l[c]) continue;
									x = g[c] ? g[c] : n;
									g[c] = s = a.axisY.convertValueToPixel(
										l[c]
									);
								} else if (
									a.axisY.scaleBreaks &&
									...
									(w[c] = x + (w[c] ? w[c] : 0)),
										(s = m[c] ? m[c] : n),
										(m[c] = x = a.axisY.convertValueToPixel(
											w[c]
										));
								else if (
									((s = a.axisY.convertValueToPixel(x)),
									0 <= t[h].y)
								) {
									var A = g[c] ? g[c] : 0;
									x = n + A;
			...
			function d() {
				...
				if (0 < b.length) {
					if (0 < q.lineThickness) {
						...
						b[0].newStrokeStyle &&
							(c.strokeStyle = b[0].newStrokeStyle);
						b[0].newLineDashArray &&
							c.setLineDash(b[0].newLineDashArray);
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (
					var k = 25 * Math.PI,
						p = Math.max(
							Math.pow(
								(0.25 * Math.min(c.height, c.width)) / 2,
								2
							) * Math.PI,
							k
						),
						...
						for (
							...
							if (
								...
								var y = (l - k / 2) << 0,
									...
									Y =
										"number" ===
										typeof x[m].whiskerThickness
											? x[m].whiskerThickness
											: "number" ===
											  typeof C.options.whiskerThickness
											? C.whiskerThickness
											: D,
									...
									la =
										"number" === typeof x[m].stemThickness
											? x[m].stemThickness
											: "number" ===
											  typeof C.options.stemThickness
											? C.stemThickness
											: D,
									...
									H =
										"number" === typeof x[m].lineThickness
											? x[m].lineThickness
											: "number" ===
											  typeof C.options.lineThickness
											? C.lineThickness
											: D,
									I = x[m].lineDashType
										? x[m].lineDashType
		...
		p.prototype.renderError = function (a) {
			var d = a.targetCanvasCtx || this.plotArea.ctx,
				b = r ? this._preRenderCtx : d,
				c = a.axisY._position
					? "left" === a.axisY._position ||
					  "right" === a.axisY._position
						? !1
						: !0
					: !1;
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
					...
					if (A)
						for (e = z._linkedSeries.id, t = 0; t < e; t++)
							!this.data[t].type.match(/(bar|column)/gi) ||
								...
								(this.data[t].type.match(/(range)/gi) &&
									(g = !0),
								D++);
					e = this.options.dataPointMinWidth
						? this.dataPointMinWidth
					...
					if (0 < y.length)
						for (var aa = z._colorSet, l = 0; l < y.length; l++) {
							var e = (z.lineColor = z.options.color
									? z.options.color
									: aa[0]),
								T = {
					...
					if (0 < k.length) {
						...
						for (g = 0; g < k.length; g++)
							if (
								...
								w = a.axisX.reversed
									? (w +
											(a.plotType.totalDataSeries * s) /
												2 -
											(a.previousDataSeriesCount + q) *
												s) <<
									  0
									: (w -
											(a.plotType.totalDataSeries * s) /
						...
						for (var f = 0; f < d.length - 3; f += 3) {
							if (d[f].newStrokeStyle || d[f].newLineDashArray)
								c.stroke(),
									...
									d[f].newStrokeStyle &&
										(c.strokeStyle = d[f].newStrokeStyle),
									d[f].newLineDashArray &&
										c.setLineDash(d[f].newLineDashArray);
							c.bezierCurveTo(
								d[f + 1].x,
								d[f + 1].y,
								d[f + 2].x,
						...
						for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
							if (u[g].newStrokeStyle || u[g].newLineDashArray)
								c.stroke(),
									...
									c.moveTo(d[f].x, d[f].y),
									u[g].newStrokeStyle &&
										(c.strokeStyle = u[g].newStrokeStyle),
									u[g].newLineDashArray &&
										c.setLineDash(u[g].newLineDashArray);
							c.bezierCurveTo(
								d[f + 1].x,
								d[f + 1].y,
								d[f + 2].x,
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
					var p = a.dataSeriesIndexes[f],
						...
						v = u.dataPoints,
						e = u._colorSet[0];
					u.risingColor = u.options.risingColor
						? u.options.risingColor
						: e;
					...
					if (0 < v.length)
						for (
							...
							if (
								...
								l = a.axisX.reversed
									? (l +
											(a.plotType.totalDataSeries * n) /
												2 -
											(a.previousDataSeriesCount + f) *
												n) <<
									  0
									: (l -
											(a.plotType.totalDataSeries * n) /
								...
								Y =
									("undefined" !==
										typeof v[m].isIntermediateSum &&
										!0 === v[m].isIntermediateSum) ||
									("undefined" !==
										typeof v[m].isCumulativeSum &&
					...
					for (
						...
						m.startAngle =
							0 === d
								...
								: f[d - 1].endAngle;
						m.startAngle =
							(m.startAngle + 2 * Math.PI) % (2 * Math.PI);
						m.endAngle =
							m.startAngle + ((2 * Math.PI) / z) * Math.abs(g.y);
						...
						c.indexLabelText &&
							...
							"inside" !== c.indexLabelPlacement &&
								...
								a.setLineDash &&
									a.setLineDash(
										R(
											c.indexLabelLineDashType,
											c.indexLabelLineThickness
										)
									),
								a.beginPath(),
								a.moveTo(e, d),
								a.lineTo(
									c.indexLabelTextBlock.x,
									c.indexLabelTextBlock.y
								),
								a.lineTo(
									c.indexLabelTextBlock.x +
										("left" === c.hemisphere ? -q : q),
									c.indexLabelTextBlock.y
								),
								a.stroke()),
							(a.lineJoin = "miter"));
			...
			function c(a, b) {
				var c = 0,
					...
					f =
						...
						b.indexLabelTextBlock.height / 2;
				return (c =
					b.indexLabelTextBlock.y > a.indexLabelTextBlock.y
						? d - e
						: c - f);
			}
			function e(a) {
			...
			function g(a, b, d) {
				...
				if (0 <= a && a < s.length) {
					...
					h =
						"right" === n.hemisphere
							? x.x +
							  Math.sqrt(Math.pow(r, 2) - Math.pow(b - x.y, 2))
							: x.x -
							  Math.sqrt(Math.pow(r, 2) - Math.pow(b - x.y, 2));
					...
					if ("inside" !== h.indexLabelPlacement) {
						...
						for (a = 0; a < s.length; a++) {
							...
							l.indexLabelTextBlock.x =
								x.x + r * Math.cos(l.midAngle);
							l.indexLabelTextBlock.y =
								x.y + r * Math.sin(l.midAngle);
								...
								0 < y &&
									(!m &&
										...
										0.3 * l.indexLabelTextBlock.maxWidth > u
											? (l.indexLabelText = "")
											: (l.indexLabelTextBlock.maxWidth =
													0.85 * u),
										0.3 * l.indexLabelTextBlock.maxWidth <
											u &&
											(l.indexLabelTextBlock.x -=
												"right" === l.hemisphere
													? 2
									...
									((y /= Math.abs(
										Math.cos(l.indexLabelAngle)
									)),
									9 < y && (y *= 0.3),
									y > d && (d = y)),
								(y = y = 0),
								0 < l.indexLabelAngle &&
								l.indexLabelAngle < Math.PI
									? ((y =
											n.y2 -
											(l.indexLabelTextBlock.y +
												l.indexLabelTextBlock.height /
									...
									(!m &&
										...
										((u =
											...
											l.indexLabelAngle < Math.PI
												...
												: 1),
										0 === g(a, y * u) && g(a, 2 * u)),
									Math.abs(l.indexLabelTextBlock.x - x.x) <
										A &&
										((y /= Math.abs(
											Math.sin(l.indexLabelAngle)
										)),
										9 < y && (y *= 0.3),
										y > d && (d = y)));
										...
										var k =
											...
											r =
												...
												h.indexLabelTextBlock.height /
													2;
										n =
											t.indexLabelTextBlock.x +
												t.indexLabelTextBlock.width <
		...
		p.prototype.renderFunnel = function (a) {
				...
				if (t && C) {
					...
					for (
						...
						a = b.color
							...
							: t.reversed
							? t._colorSet[
									(C.length - 1 - y) % t._colorSet.length
							  ]
							: t._colorSet[y % t._colorSet.length];
						c =
							b.indexLabelPlacement ||
							t.indexLabelPlacement ||
							"outside";
						e =
							...
							(r ? "transparent" : null);
						d =
							b.indexLabelFontColor ||
							t.indexLabelFontColor ||
							"#979797";
						g = u(b.indexLabelFontSize)
							? t.indexLabelFontSize
							: b.indexLabelFontSize;
						l =
							b.indexLabelFontStyle ||
							t.indexLabelFontStyle ||
							"normal";
						h =
							b.indexLabelFontFamily ||
							t.indexLabelFontFamily ||
							"arial";
						m =
							b.indexLabelFontWeight ||
							t.indexLabelFontWeight ||
							"normal";
						a =
						...
						(a = P[h]),
							...
							t.reversed
								? (J[h].textBlock.y + J[h].height > pa + D &&
										(J[h].textBlock.y =
											pa + D - J[h].height),
								  J[h].textBlock.y < wa - D &&
										(J[h].textBlock.y = wa - D))
								: (J[h].textBlock.y < pa - D &&
										(J[h].textBlock.y = pa - D),
					...
					for (var d = 0; d < P.length; d++)
						0 == J[d].textBlock.text.length
							...
							: ((a = P[d]),
							  ...
							  t.reversed
									? (J[d].textBlock.y + J[d].height >
											pa + D &&
											(J[d].textBlock.y =
												pa + D - J[d].height),
									  J[d].textBlock.y < wa - D &&
											(J[d].textBlock.y = wa - D))
									: (J[d].textBlock.y < pa - D &&
											(J[d].textBlock.y = pa - D),
			...
			function k(a, b, c) {
				...
				a._animator.animate(
					...
					function (c) {
						...
						v(d);
						H &&
							("inside" !== t.indexLabelPlacement ? s(d) : g(),
							p(d));
						1 <= c && (ja = !1);
					},
					null,
				...
				for (var b, c, d, e, g = 0; g < P.length; g++)
					(e = 1 === J[g].lineThickness % 2 ? 0.5 : 0),
						...
						J[g].isDirty ||
							...
							a.setLineDash &&
								a.setLineDash(
									R(J[g].lineDashType, J[g].lineThickness)
								),
							a.beginPath(),
							a.moveTo(b, c),
							a.lineTo(d, e),
			...
			function n(a) {
				for (
					a += 1;
					a <= P.length && a != P.length && J[a].isDirty;
					a++
				);
				return a;
			}
			function f(a) {
				...
				return b
					? ((a = b.y6
							? a > b.y6
								? b.x3 +
								  ((b.x4 - b.x3) / (b.y4 - b.y3)) * (a - b.y3)
								: b.x2 +
								  ((b.x3 - b.x2) / (b.y3 - b.y2)) * (a - b.y2)
							: b.x2 +
							  ((b.x3 - b.x2) / (b.y3 - b.y2)) * (a - b.y2)),
					  { x1: a, x2: a })
					: -1;
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				if (
					...
					var y = [],
						...
						I =
							"area" ===
							(t.valueRepresents ? t.valueRepresents : "height")
								? b()
								: d();
					if (-1 !== I) {
						if (t.reversed)
						...
						this.funnelPyramidClickHandler = function (a) {
							...
							if (
								...
								if ("funnel" === t.type || "pyramid" === t.type)
									t.reversed
										? (C[C.length - 1 - a].exploded = C[
												C.length - 1 - a
										  ].exploded
												? !1
												: !0)
										: (C[a].exploded = C[a].exploded
												? !1
												: !0);
								k(z, b, 500);
							}
						...
						return {
							...
							animationCallback: function (a, b) {
								...
								1 <= a &&
									(k(z, -1, 500), v(z.plotArea.ctx || z.ctx));
							},
							easingFunction: M.easing.easeInQuad,
							animationBase: 0,
						};
				...
				do {
					...
					if (b.percentFormatString) k = b.percentFormatString;
						...
						var k = "#,##0.",
							h = Math.max(
								Math.ceil(
									Math.log(1 / Math.abs(m)) / Math.LN10
								),
								2
							);
				...
				if (q.dataPoints && q.dataPoints.length)
					if (
						...
						for (var z = 0; z < q.dataPoints.length; z++) {
							...
							(x.showInLegend ||
								(q.showInLegend && !1 !== x.showInLegend)) &&
								k.push(n);
						}
			}
				...
				for (var h = m[k], s = 0, q = 0; q < h.items.length; q++) {
					var n = h.items[q],
						f =
							n.textBlock.x +
							a +
							(0 === q ? 0.2 * g : this.horizontalSpacing),
						p = d + l,
						u = f;
					...
					this.ctx.rect(
						...
						d,
						c,
						Math.max(e - (e % this.lineHeight), 0)
					);
					this.ctx.clip();
					if (
						"line" === n.chartType ||
		...
		F.prototype.getDataPointAtXY = function (a, d, b) {
			...
			for (;;) {
				g = 0 < m ? q + e : q - e;
				if (0 <= g && g < this.dataPoints.length) {
					var n = this.chart._eventManager.objectMap[
							this.dataPointIds[g]
						],
						f = this.dataPoints[g],
						p = null;
							...
							case "doughnut":
								...
								r =
									"doughnut" === this.type
										...
										: 0;
								p = Math.sqrt(
									Math.pow(u.x - a, 2) + Math.pow(u.y - d, 2)
								);
								p < n.radius &&
									p > r &&
		...
		z.prototype.createLabels = function () {
			...
			if (
				...
				if (this.labels) {
					a = Math.ceil(c);
					for (
						var c = Math.ceil(this.intervalStartPosition),
							f = !1,
							b = c;
					...
					f &&
						((this.interval = a), (this.intervalStartPosition = c));
				}
				...
				(l =
					...
					2 <= this._labels.length
						? (this.lineCoordinates.width *
								Math.log(
									Math.min(
										this._labels[this._labels.length - 1]
											.position /
											this._labels[
												this._labels.length - 2
											].position,
					...
					this.chart.panEnabled ||
						(m =
							"undefined" === typeof this.options.labelWrap ||
							this.labelWrap
			...
			if (this.labelAutoFit || this.options.labelAutoFit)
				if (
					...
					if (
								...
								if (
									...
									(p =
										0 != this.labelAngle
											...
											: g),
									(this.sessionVariables.labelMaxHeight = m = this
										.labelWrap
										? (h -
												p *
													Math.sin(
						...
						for (b = 0; b < this._labels.length; b++)
							(a = this._labels[b].textBlock),
								(a.maxWidth = this.labelMaxWidth = u(
									this.options.labelMaxWidth
								)
									? this.sessionVariables.labelMaxWidth
									: this.options.labelMaxWidth),
								(a.fontSize = this.labelFontSize = u(
									this.options.labelFontSize
								)
									? this.sessionVariables.labelFontSize
									: this.options.labelFontSize),
								(a.angle = this.labelAngle = u(
									this.options.labelAngle
								)
									? this.sessionVariables.labelAngle
									: this.labelAngle),
								(a.wrap = this.labelWrap = u(
									this.options.labelWrap
								)
		...
		z.setLayout = function (a, d, b, c, e, g) {
			...
			for (f = 0; f < n.length; f++)
				if (
					n[f] &&
					n[f].scaleBreaks &&
					n[f].scaleBreaks._appliedBreaks.length
				)
					for (
						var r = n[f].scaleBreaks._appliedBreaks, v = 0;
						v < r.length &&
						!(r[v].startValue > n[f].viewportMaximum);
						v++
					)
			...
			for (f = 0; f < n.length; f++)
				if (n[f].title)
					switch (n[f]._position) {
						case "left":
							n[f]._titleTextBlock.maxWidth =
								n[f].titleMaxWidth || g.height;
			...
			if ("normal" === e) {
				for (
					...
					if (b && 0 < b.length)
						for (D = [], f = P = 0; f < b.length; f++)
							D.push(
								Math.ceil(
									b[f]
										? b[f].createLabelsAndCalculateWidth()
										: 0
								)
							),
								(P += D[f]),
						...
						D.push(
							Math.ceil(
								b[0] ? b[0].createLabelsAndCalculateWidth() : 0
							)
						);
					O.push(D);
					if (c && 0 < c.length)
						...
						y.push(
							Math.ceil(
								c[0] ? c[0].createLabelsAndCalculateWidth() : 0
							)
						);
					Q.push(y);
					...
					if (a && 0 < a.length)
						...
						C.push(
							Math.ceil(
								a[0] ? a[0].createLabelsAndCalculateHeight() : 0
							)
						);
					M.push(C);
					if (d && 0 < d.length)
						...
						x.push(
							Math.ceil(
								d[0] ? d[0].createLabelsAndCalculateHeight() : 0
							)
						);
					N.push(x);
					if (a && 0 < a.length)
								...
								a[f]._labels &&
									...
									(l =
										"dateTime" === a[f].valueType
											? a[f]._labels[
													a[f]._labels.length - 2
											  ]
											: a[f]._labels[
													a[f]._labels.length - 1
											  ]),
									(z =
										h.textBlock.width *
											Math.cos(
												(Math.PI / 180) *
													Math.abs(h.textBlock.angle)
											) +
										(h.textBlock.height -
											l.textBlock.fontSize / 2) *
											Math.sin(
												(Math.PI / 180) *
													Math.abs(h.textBlock.angle)
											)),
					...
					if (d && 0 < d.length)
						for (f = 0; f < d.length; f++)
							(d[f].lineCoordinates.x1 = Math.round(
								g.x1 + P + K
							)),
								...
								d[f]._labels &&
									...
									(l =
										"dateTime" === d[f].valueType
											? d[f]._labels[
													d[f]._labels.length - 2
											  ]
											: d[f]._labels[
													d[f]._labels.length - 1
											  ]),
									(z =
										h.textBlock.width *
											Math.cos(
						...
						for (f = 0; f < b.length; f++)
							(K = p.isNavigator ? 0 : 10),
								b[f] &&
									((m = Math.round(
										a[0]
											? a[0].lineCoordinates.x1
											: d[0].lineCoordinates.x1
									)),
									(K =
										b[f]._labels && 0 < b[f]._labels.length
											? b[f]._labels[
													b[f]._labels.length - 1
											  ].textBlock.height / 2
											: q),
									(l = Math.round(
									...
									(K =
										0 < a.length
											...
											? b[f]._labels[0].textBlock.height /
											  2
											: q),
					...
					if (c && 0 < c.length)
						for (f = 0; f < c.length; f++)
							c[f] &&
								((m = Math.round(
									a[0]
										? a[0].lineCoordinates.x2
										: d[0].lineCoordinates.x2
								)),
								(k = Math.round(m)),
								(K =
									c[f]._labels && 0 < c[f]._labels.length
										? c[f]._labels[c[f]._labels.length - 1]
												.textBlock.height / 2
										: 0),
								(l = Math.round(
									g.y1 + X + W < Math.max(K, q)
							...
							d[f].calculateValueToPixelConversionParameters(),
								...
								d[f]._labels &&
									...
									((A =
										(d[f].logarithmic
											? Math.log(
													d[f]._labels[1].position /
														d[f].viewportMinimum
											  ) /
											  d[f].conversionParameters
													.lnLogarithmBase
											: d[f]._labels[1].position -
											  d[f].viewportMinimum) *
											Math.abs(
				...
				for (N = []; 4 > v; ) {
					...
					if (a && 0 < a.length)
						...
						F.push(
							Math.ceil(
								a[0] ? a[0].createLabelsAndCalculateWidth() : 0
							)
						);
					M.push(F);
					if (d && 0 < d.length)
						for (z = [], f = V = 0; f < d.length; f++)
							z.push(
								Math.ceil(
									d[f]
										? d[f].createLabelsAndCalculateWidth()
										: 0
								)
							),
								(V += z[f]),
						...
						z.push(
							Math.ceil(
								d[0] ? d[0].createLabelsAndCalculateWidth() : 0
							)
						);
					N.push(z);
					if (b && 0 < b.length)
					...
					if (b && 0 < b.length)
						...
						q.push(
							Math.ceil(
								b[0] ? b[0].createLabelsAndCalculateHeight() : 0
							)
						);
					E.push(q);
					if (c && 0 < c.length)
						...
						A.push(
							Math.ceil(
								c[0] ? c[0].createLabelsAndCalculateHeight() : 0
							)
						);
					t.push(A);
					if (b && 0 < b.length)
		...
		z.prototype.calculateBreaksSizeInValues = function () {
			for (
				var a =
					...
					c =
						this.scaleBreaks &&
						!u(this.scaleBreaks.options.spacing),
					e,
					g = 0;
				g < d.length;
				g++
				...
				(e = c || !u(d[g].options.spacing)),
					...
					(d[g].size =
						0 > d[g].spacing ? 0 : Math.abs(d[g].spacing / b)),
					this.logarithmic &&
						...
						for (h = 0; h < this._labels.length; h++)
							(q = this._labels[h]),
								q.position < this.viewportMinimum ||
									...
									(b += m));
						b > this.lineCoordinates.width * e &&
							this.labelAutoFit &&
							(d = !0);
					}
				if ("left" === this._position || "right" === this._position)
		...
		z.prototype.renderInterlacedColors = function () {
			...
			if (
				...
				for (
					...
					d
						? ((d = this.getPixelCoordinatesOnAxis(
								this._labels[e].position
						  )),
						  (b =
				...
				for (
					...
					d
						? ((b = this.getPixelCoordinatesOnAxis(
								this._labels[e].position
						  )),
						  (d =
								e + 1 > this._labels.length - 1
					...
					if (
						...
						if ("outside" === b.stripLine.labelPlacement)
							...
							(b.textBlock.angle = -90),
								"bottom" === this._position
									? ((b.textBlock.maxWidth = this.options
											.stripLines[c].labelMaxWidth
											? this.options.stripLines[c]
													.labelMaxWidth
			...
			if ("bottom" === this._position || "top" === this._position) {
				if (this.lineThickness) {
					this.reversed
						? ((e = this.lineCoordinates.x2),
						  (g = this.lineCoordinates.x1))
						: ((e = this.lineCoordinates.x1),
					...
					if (
						...
						if (u(this.scaleBreaks.lastBreakIndex))
							...
							for (
								...
								d.moveTo(e, m),
									d.lineTo(
										this.scaleBreaks._appliedBreaks[l]
											.startPixel + b,
										m
									),
									(e =
				...
				this.reversed
					? ((e = this.lineCoordinates.y1),
					  (g = this.lineCoordinates.y2))
					: ((e = this.lineCoordinates.y2),
		...
		z.prototype.getXValueAt = function (a) {
			...
			"left" === this._position
				...
				: "bottom" === this._position &&
				  (d = this.convertPixelToValue(a.x));
			return d;
		};
				...
				this.logarithmic
					? ((d.lnLogarithmBase = Math.log(this.logarithmBase)),
					  (d.pixelPerUnit =
							...
							Math.log(Math.abs(c))))
					: (d.pixelPerUnit =
							((this.reversed ? -1 : 1) * b) / Math.abs(c)),
						...
						if (
							((!u(this.sessionVariables.newViewportMinimum) &&
								this.sessionVariables.newViewportMinimum >=
									this.scaleBreaks._appliedBreaks[c]
										.startValue) ||
			...
			if (this.scaleBreaks)
				for (m = 0; m < this.scaleBreaks._appliedBreaks.length; m++)
					if (
						((!u(this.sessionVariables.newViewportMinimum) &&
							this.sessionVariables.newViewportMinimum >=
								this.scaleBreaks._appliedBreaks[m]
									.startValue) ||
							(!u(this.options.minimum) &&
								this.options.minimum >=
									this.scaleBreaks._appliedBreaks[m]
			...
			"axisX" === this.type
				...
				: "axisY" === this.type &&
				  ...
				  0 >= c && !isFinite(e)
						...
						: isFinite(e) || (e = c),
				  1 === c && 1 === e
						? ((e *= this.logarithmBase - 1 / this.logarithmBase),
						  (c = 1))
						: 1 === e / c
						? ((m = Math.min(
				...
				this.viewportMinimum =
					"axisX" === this.type
						...
						: Math.pow(
								this.logarithmBase,
								this.interval *
									Math.floor(Math.log(c) / d / this.interval)
						  );
			if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
				this.viewportMaximum =
					"axisX" === this.type
						...
						: Math.pow(
								this.logarithmBase,
								this.interval *
									Math.ceil(Math.log(e) / d / this.interval)
						  );
				...
				"axisX" === this.type
					...
					: "axisY" === this.type &&
					  ...
					  isFinite(c) || isFinite(e)
							? 1 === c && 1 === e
								? ((e *= this.logarithmBase),
								  (c /= this.logarithmBase))
								: 1 === e / c
								? ((m = Math.pow(
										this.logarithmBase,
										this.interval
								...
								: ((m = Math.min(
										(e / c) *
											Math.pow(this.logarithmBase, 0.01),
										Math.pow(this.logarithmBase, 0.04)
								  )),
								  1 !== e && (e *= m),
								  1 !== c && (c /= m))
		...
		L.prototype.createUserOptions = function (a) {
			if ("undefined" !== typeof a || this.options._isPlaceholder) {
				...
				this.options._isPlaceholder ||
					...
					(d = this.parent.options[this.optionsName].indexOf(
						this.options
					)));
		...
		L.prototype.render = function (a) {
			if (
				...
				this.ctx.setLineDash &&
					this.ctx.setLineDash(R(this.lineDashType, q));
				if (
		...
		X.prototype.render = function () {
			...
			if (0 < d) {
				...
				this.ctx.setLineDash &&
					this.ctx.setLineDash(R(this.lineDashType, d));
				if (
						...
						h =
							"xySwapped" === this.chart.plotInfo.axisPlacement
								? 50 < this.parent.range
									? 0
									: 500 < this.chart.width &&
									  25 > this.parent.range
									? 2
									: Math.floor(
											Math.abs(
												Math.log(this.parent.range) /
													Math.LN10
											)
									  ) +
									  (5 > this.parent.range
			...
			if (this.snapToDataPoint) {
				...
				if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
					...
					for (var r = 0; r < this.parent.dataSeries.length; r++)
						(f = this.parent.dataSeries[r].getDataPointAtX(
							n,
							!0
						)) &&
							0 <= f.index &&
					...
					if (
						...
						for (
							...
							if (m[n].dataPoint.y && m[n].dataPoint.y.length)
								...
								(D += m[n].dataPoint.y),
									(v = Math.abs(
										a - this.parent.convertValueToPixel(D)
									)),
									v < f && ((f = v), (r = n));
							...
							if (m[n].dataPoint.y && m[n].dataPoint.y.length)
								...
								(D += m[n].dataPoint.y),
									...
									(t =
										100 *
										(D /
											m[n].dataSeries.plotUnit
												.dataPointYSums[t])),
									(v = Math.abs(
										a - this.parent.convertValueToPixel(t)
									)),
									v < f && ((f = v), (r = n));
					else
						for (
					...
					if (
						...
						if (
							...
							"stackedBar" === this.parent.dataSeries[r].type
						) {
							f = Math.abs(
								a -
									this.parent.convertValueToPixel(
							...
							m =
								1 === p.lineWidth % 2
									? (this.parent.convertValueToPixel(D) <<
											0) +
									  0.5
							...
							"stackedBar100" === this.parent.dataSeries[r].type
						) {
							f = Math.abs(
								a -
									this.parent.convertValueToPixel(
							...
							m =
								1 === p.lineWidth % 2
									? (this.parent.convertValueToPixel(t) <<
											0) +
									  0.5
						...
						l.x + l.width > this.chart.bounds.x2
							...
							: l.x < this.chart.bounds.x1 &&
							  (l.x = this.chart.bounds.x1);
						l.y =
							this.parent.lineCoordinates.y2 + l.fontSize / 2 + 2;
					} else if (
						"left" === this.parent._position ||
						"right" === this.parent._position
					) {
							...
							"dateTime" === this.parent.valueType
								...
								: "number" === this.parent.valueType &&
								  (l.text = this.labelFormatter
										...
										: this.label);
						l.y =
							g + l.fontSize / 2 - l.measureText().height / 2 + 2;
					...
					b = c = m =
						1 === p.lineWidth % 2
							? (this.parent.convertValueToPixel(k.dataPoint.x) <<
									0) +
							  0.5
							: this.parent.convertValueToPixel(k.dataPoint.x) <<
							  0;
					...
					if (
						...
						for (
							...
							if (m[n].dataPoint.y && m[n].dataPoint.y.length)
								...
								(D += m[n].dataPoint.y),
									(v = Math.abs(
										d - this.parent.convertValueToPixel(D)
									)),
									v < f && ((f = v), (r = n));
					else if (
									...
									(t =
										...
										(D /
											m[n].dataSeries.plotUnit
												.dataPointYSums[t])),
									(v = Math.abs(
										d - this.parent.convertValueToPixel(t)
									)),
									v < f && ((f = v), (r = n));
					else
						for (
						...
						for (n = r; 0 <= n; n--)
							(D += m[n].dataPoint.y),
								...
								(t =
									100 *
									(D /
										m[n].dataSeries.plotUnit.dataPointYSums[
											t
										])),
								(v = Math.abs(
									d - this.parent.convertValueToPixel(t)
						...
						"waterfall" === this.parent.dataSeries[r].type
							? ((m =
							  ...
							  (l.text = this.labelFormatter
									...
									: u(this.options.label)
									? ba(
											k.dataSeries.dataPointEOs[k.index]
												.cumulativeSum,
											this.valueFormatString,
											this.chart._cultureInfo
									  )
									...
									(f = this.parent.dataSeries[
										...
										(l.text = this.labelFormatter
											? this.labelFormatter({
													...
													axis: this.parent.options,
													crosshair: this.options,
													value: this.parent.convertPixelToValue(
														a
													),
											  })
											: u(this.options.label)
							...
							"dateTime" === this.parent.valueType
								...
								: "number" === this.parent.valueType &&
								  (l.text = this.labelFormatter
										...
										: this.label);
						l.y =
							d + l.fontSize / 2 - l.measureText().height / 2 + 2;
						l.y - l.fontSize / 2 < this.chart.bounds.y1
							? (l.y = this.chart.bounds.y1 + l.fontSize / 2 + 2)
							: l.y + l.measureText().height - l.fontSize / 2 >
									this.chart.bounds.y2 &&
		...
		$.prototype.mouseMoveHandler = function (a, d) {
			(this._lastUpdated &&
				4 > new Date().getTime() - this._lastUpdated) ||
		...
		$.prototype._updateToolTip = function (a, d, b) {
			...
			if (!this.chart.disableToolTip) {
				...
				if (
					...
					if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
						...
						if (this.chart.axisX)
							for (var p = 0; p < this.chart.axisX.length; p++) {
								for (
									var k = this.chart.axisX[
											p
										].convertPixelToValue({ y: d }),
										h = null,
										c = 0;
									c < this.chart.axisX[p].dataSeries.length;
									c++
								)
									(h = this.chart.axisX[p].dataSeries[
										c
									].getDataPointAtX(k, b)) &&
										0 <= h.index &&
										((h.dataSeries = this.chart.axisX[
											p
										].dataSeries[c]),
						...
						if (this.chart.axisX2)
							for (p = 0; p < this.chart.axisX2.length; p++) {
								...
								for (
									...
									(h = this.chart.axisX2[p].dataSeries[
										c
									].getDataPointAtX(k, b)) &&
										0 <= h.index &&
										((h.dataSeries = this.chart.axisX2[
											p
										].dataSeries[c]),
										null !== h.dataPoint.y && l.push(h));
								h = null;
					...
					b = l[0];
					for (c = 0; c < l.length; c++)
						l[c].dataPoint.x.valueOf() ===
							b.dataPoint.x.valueOf() && g.push(l[c]);
					l = null;
				} else {
					if ((h = this.chart.getDataPointAtXY(a, d, b)))
						...
						if (
							...
							0 < h &&
								"undefined" !==
									typeof this.chart._eventManager.objectMap[
										h
									])
						) {
				...
				if (0 < g.length && (this.highlightObjects(g), this.enabled))
					if (
						...
						try {
							(this.contentDiv.style.background = this
								.backgroundColor
								? this.backgroundColor
								: r
								? "rgba(255,255,255,.9)"
								...
								(this.contentDiv.style.color = this.fontColor
									? this.fontColor
									: "#000000"),
								(this.contentDiv.style.fontFamily = this
									.fontFamily
									? this.fontFamily
									: "Calibri, Arial, Georgia, serif;"),
								(this.contentDiv.style.fontWeight = this
									.fontWeight
									? this.fontWeight
									: "normal"),
								(this.contentDiv.style.fontStyle = this
									.fontStyle
									? this.fontStyle
									: r
									? "italic"
							...
							("line" !== g[0].dataSeries.type &&
								...
								? "bar" === g[0].dataSeries.type ||
								  ...
								  "stackedBar100" === g[0].dataSeries.type
									...
									: d
								: g[0].dataSeries.axisY.convertValueToPixel(
										g[0].dataPoint.y
								  );
						d = -d + 10;
						...
						"rangeSplineArea" === c.type
							...
							? (d.save(),
							  ...
							  0 < e.stemThickness &&
									...
									d.lineTo(
										e.x3,
										e.y1 + e.whiskerThickness / 2
									),
									d.stroke(),
									d.beginPath(),
									d.moveTo(
										e.x3,
										e.y4 - e.whiskerThickness / 2
									),
									d.lineTo(
										e.x3,
					...
					(b = a[l].dataSeries),
						...
						0 === l &&
							...
							(this.chart.axisX && 0 < this.chart.axisX.length
								? (h +=
										"undefined" !==
										typeof this.chart.axisX[0].labels[c.x]
								...
								: this.chart.axisX2 &&
								  ...
								  (h +=
										"undefined" !==
										typeof this.chart.axisX2[0].labels[c.x]
											? this.chart.axisX2[0].labels[c.x]
											: "{x}"),
							(h += "</br>"),
							(h = this.chart.replaceKeywordsWithValue(
								h,
								c,
								b,
								e
		...
		$.prototype.enableAnimation = function () {
			if (!this.container.style.WebkitTransition) {
				var a = this.getContainerTransition(
					this.containerTransitionDuration
				);
		...
		ha.prototype.mouseEventHandler = function (a) {
			if ("mousemove" === a.type || "click" === a.type) {
				...
				if (
					...
					if (
						((c = this.objectMap[c]), "dataPoint" === c.objectType)
					) {
				...
				for (b = 0; b < d.length; b++) {
					...
					"click" === a.type
						...
						: "mousemove" === a.type &&
						  this.fireEvent(d[b], "mousemove", a);
				}
			}
		};
		...
		ga.prototype.animate = function (a, d, b, c, e) {
			...
			for (a = []; 0 < this.animations.length; )
				if (
					...
					d.startTime <= b &&
						((c = e(
							Math.min(b - d.startTime, d.duration),
							0,
							1,
							d.duration
						)),
